    ...
    public static void main(String[] args) {
        ...
        while (gameloop) {
            ...
            if (input.charAt(0) == '1') {
                ...
                // Safari Zone - Queueing up the Pokémon
                ...
                while (true) {  // Loop repeatedly to prompts user enter their Pokémon names until valid input is provided
                    ...
                    if (isValidInput(pokemonArray, safariZoneInput)) {  // If the input is valid, the loop breaks and proceeds to the next step
                        break; 
                    } else {
                ...
                sortPokemon(pokemonArray);  // Calls sortPokemon to sort the Pokémon names according to their unique preferences
            }
        }
    }
...
public static boolean isValidInput(String[] pokemonArray, String input) {
        if (pokemonArray.length < 6) {  //  Ensures at least 6 Pokémon names are entered
            return false;
        }
        if (!input.contains(", ")) {    //  Ensures names are separated by ", "
            return false;
        }
        
        for (String pokemon : pokemonArray) {
            if (pokemon.isEmpty() || !Character.isUpperCase(pokemon.charAt(0))) {   // Ensures each Pokémon name starts with an uppercase letter
                return false;
            }
        }
        return true;
    ...
    public static void sortPokemon(String[] pokemonArray) {
        ...
        // If Eevee is present, it moved to the beginning of the list
        ...
        // If Pikachu is present, it moved to the center of the list
        ...
        // If Snorlax is present, it moved to the end of the list
        ...
        // If Pikachu and Jigglypuff are present, Jigglypuff moved next to Pikachu
        ...
        // If Machop and Snorlax are present, Machop moved next to Snorlax
        ...
        // If Bulbasaur and Charmander are present, they moved to ensure they are not next to each other
